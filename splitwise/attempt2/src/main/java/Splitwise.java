...
public class Splitwise {
    ...
    public void demo(){
        ...
        splits.add(split2);
        splits.add(split3);
        group.createExpense("Exp1001", "Breakfast", 900, splits, SPLIT_TYPE.EQUAL, userController.getUser("U1001"));
        ...
        group.createExpense("Exp1002", "Lunch", 500, splits2, SPLIT_TYPE.UNEQUAL, userController.getUser("U2001"));
